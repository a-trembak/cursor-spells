...
| Leave to | Examples |
|----------|----------|
| `review-deadcode` | Unused imports/exports/params, commented-out code, historical comments |
| `review-performance` | N+1 across requests, missing pagination/indexes, re-render storms, bundle bloat, cache stampedes |
| `review-architecture` | Layering / package boundaries / circular deps / god-file placement |
| `review-logic` | Incorrect behavior, edge-case bugs, non-idiomatic stack misuse that changes meaning |
| `review-lint` | Anything the project's linter/typechecker already flags |
