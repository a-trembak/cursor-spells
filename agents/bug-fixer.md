...
8. Hand off with `next_skill: engineer-reviewer`, `repo → branch`, root-cause summary **with evidence** (file:line or test), verification evidence, and `skill_missing` notes.
