...
# Gates S1–S10 live in the shared checklist
assert_grep s1_sql "$CHECKLIST" "## S1"
assert_grep s2_cmd "$CHECKLIST" "## S2"
assert_grep s3_xss "$CHECKLIST" "## S3"
assert_grep s4_csrf "$CHECKLIST" "## S4"
assert_grep s5_access "$CHECKLIST" "## S5"
assert_grep s6_ssrf "$CHECKLIST" "## S6"
assert_grep s7_path "$CHECKLIST" "## S7"
assert_grep s8_secret "$CHECKLIST" "## S8"
assert_grep s9_deser "$CHECKLIST" "## S9"
assert_grep s10_session "$CHECKLIST" "## S10"
