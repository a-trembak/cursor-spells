...
**Architecture:** Closed-set tokens on the existing Teach-review miss gate plus a Capture-escape destination gate. `csp-review-learn` `mode:capture` becomes opt-in. Contract grep tests lock the tokens and the “no auto-capture” rule.
...
| `agents/csp-review-learn.md` | Same capture eligibility |
| `agents/csp-engineer-reviewer.md`, `skills/engineer-review/SKILL.md` | Gate then branch; no auto-capture |
| `agents/csp-pr-reviewer.md`, `skills/pr-review/SKILL.md` | Same |
| `commands/csp-capture-escape.md` | Destination gate |
| `commands/csp-teach-review.md`, `skills/teach-review/SKILL.md` | Kit-only; mention the other store |
